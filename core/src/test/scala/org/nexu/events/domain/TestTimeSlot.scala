...
class TestTimeSlot extends FunSuite {
  ...
  test("Time is not overlapping as it's in the past") {
    val referenceTimeSlot: TimeSlot = new TimeSlot(LocalDateTime.parse("2010-06-30T01:20+02:00"), time.Duration.ofHours(1))
    val isOverlapping: Boolean = referenceTimeSlot
      .isOverlappingWith(new TimeSlot(LocalDateTime.parse("2010-06-30T00:20+02:00"), time.Duration.ofHours(1)))
  ...
  test("Time is not overlapping as it's in the future") {
    val referenceTimeSlot: TimeSlot = new TimeSlot(LocalDateTime.parse("2010-06-30T01:20+02:00"), time.Duration.ofHours(1))
    val isOverlapping: Boolean = referenceTimeSlot
      .isOverlappingWith(new TimeSlot(LocalDateTime.parse("2010-06-30T02:20+02:00"), time.Duration.ofHours(1)))
  ...
  test("Start Time outside of the lower bound of the timeslot. Ending time inside") {
    val referenceTimeSlot: TimeSlot = new TimeSlot(LocalDateTime.parse("2010-06-30T01:20+02:00"), time.Duration.ofHours(1))
    val isOverlapping: Boolean = referenceTimeSlot
      .isOverlappingWith(new TimeSlot(LocalDateTime.parse("2010-06-30T01:00+02:00"), time.Duration.ofHours(1)))
  ...
  test("End Time outside of the higher bound of the timeslot. Start time inside") {
    val referenceTimeSlot: TimeSlot = new TimeSlot(LocalDateTime.parse("2010-06-30T01:20+02:00"), time.Duration.ofHours(1))
    val isOverlapping: Boolean = referenceTimeSlot
      .isOverlappingWith(new TimeSlot(LocalDateTime.parse("2010-06-30T02:00+02:00"), time.Duration.ofHours(1)))

    assert(isOverlapping, "02:00 until 02:20 is overlapping")
  }

  test("One timeslot inside another one") {
    val referenceTimeSlot: TimeSlot = new TimeSlot(LocalDateTime.parse("2010-06-30T01:20+02:00"), time.Duration.ofHours(2))
    val isOverlapping: Boolean = referenceTimeSlot
      .isOverlappingWith(new TimeSlot(LocalDateTime.parse("2010-06-30T01:30+02:00"), time.Duration.ofHours(1)))
